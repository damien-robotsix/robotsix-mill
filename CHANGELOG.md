...
- Add `inline-snapshot` snapshot test for the auto-generated OpenAPI
  schema (`tests/runtime/test_openapi_schema.py`), catching route,
  parameter, and response-model drift at CI time.
