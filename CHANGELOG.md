...
- Fix stale `forge/gitlab.py` path references in the `forge_parity` agent definition, updated to `forge/gitlab/core.py` after the GitLab adapter was refactored into a package.
