...
* **ci_fix:** drop raw job logs from the per-cycle history note ([#3164](https://github.com/damien-robotsix/robotsix-mill/issues/3164)) ([f82cb81](https://github.com/damien-robotsix/robotsix-mill/commit/f82cb81ee1166dd5ca86557d7b03493209430a64))
...
* **langfuse:** skip string observation IDs in trace_step_usage_records ([#3163](https://github.com/damien-robotsix/robotsix-mill/issues/3163)) ([550157d](https://github.com/damien-robotsix/robotsix-mill/commit/550157d71b6cd44553e4ca822355784c4756c2ea))
...
* **tests:** deflake stale-branch cleanup loop test ([#3165](https://github.com/damien-robotsix/robotsix-mill/issues/3165)) ([d3f736b](https://github.com/damien-robotsix/robotsix-mill/commit/d3f736b853e550652ad3be9cdd3de4e208155ae3))
...
* agent_limitation — Reviewer-agreement classifier returned DISAGREE for purely administrative reviewer feedbac (20260807T145619Z-agent-limitation-reviewer-agreement-clas-fb70) ([#2843](https://github.com/damien-robotsix/robotsix-mill/issues/2843)) ([fd1821f](https://github.com/damien-robotsix/robotsix-mill/commit/fd1821f8b62065a8052146a5117ba96ab27ff0d4))
* Display per-job CI status in the merge-info drawer (board-mill.js) (20260809T161458Z-display-per-job-ci-status-in-the-merge-i-1c0f) ([#2878](https://github.com/damien-robotsix/robotsix-mill/issues/2878)) ([601a90b](https://github.com/damien-robotsix/robotsix-mill/commit/601a90b71e5f23d4eade83256c8ea4165927cf9a))
* Emit a ticket state-change notification so paused chat monitors can wake (20260809T145846Z-emit-a-ticket-state-change-notification-c521) ([#2874](https://github.com/damien-robotsix/robotsix-mill/issues/2874)) ([d7024b0](https://github.com/damien-robotsix/robotsix-mill/commit/d7024b0639fd8c51bd33960679ec1ead7d3999f1))
* Expose a chat-allowlisted endpoint to close/resolve an open [ASK_USER] comment thread (20260809T102651Z-expose-a-chat-allowlisted-endpoint-to-cl-a869) ([#2870](https://github.com/damien-robotsix/robotsix-mill/issues/2870)) ([93d2d2a](https://github.com/damien-robotsix/robotsix-mill/commit/93d2d2a8792935619c10b4d940cf70b62de11169))
* Expose the diagnostic event store over the API (GET /diagnostic-events) — the CI-failure learning loop is unobservable (20260809T062409Z-expose-the-diagnostic-event-store-over-t-213c) ([#2864](https://github.com/damien-robotsix/robotsix-mill/issues/2864)) ([4c417fe](https://github.com/damien-robotsix/robotsix-mill/commit/4c417fe61d28e10ebc27b19b7ca1fb4e79cdada4))
* Harden forge-auth configuration validation and recovery (20260802T184753Z-harden-forge-auth-configuration-validati-e75b) ([#2868](https://github.com/damien-robotsix/robotsix-mill/issues/2868)) ([0bf63d0](https://github.com/damien-robotsix/robotsix-mill/commit/0bf63d0409dba15e29bedc561e535c28bbbe5e5c))
* Missing tool: force rebase of stale PRs from human_mr_approval state (20260809T060436Z-missing-tool-force-rebase-of-stale-prs-f-6303) ([#2861](https://github.com/damien-robotsix/robotsix-mill/issues/2861)) ([c5f5a40](https://github.com/damien-robotsix/robotsix-mill/commit/c5f5a40c8782e054edf2c10b34ca6a4d9e6925a7))
* Monitor for upstream CI breakage on target branch should block PRs before exhausting auto-fix cycles (20260805T105204Z-monitor-for-upstream-ci-breakage-on-targ-b553) ([#2839](https://github.com/damien-robotsix/robotsix-mill/issues/2839)) ([6196e94](https://github.com/damien-robotsix/robotsix-mill/commit/6196e945d1d91ee3b0cdcfd295324b70245e2953))
* Skip human approval re-request when sensitive-path PR diff is identical to previously approved diff (20260808T091309Z-skip-human-approval-re-request-when-sens-b0c0) ([#2851](https://github.com/damien-robotsix/robotsix-mill/issues/2851)) ([4636479](https://github.com/damien-robotsix/robotsix-mill/commit/46364799f848e696acfe8ea9e1f787fc9621bbbb))


### Bug Fixes

* add is_disk_full_error check to retry.py is_transient to avoid burning retries on ENOSPC (20260810T075109Z-fix-add-is-disk-full-error-check-to-retr-5fac) ([#2887](https://github.com/damien-robotsix/robotsix-mill/issues/2887)) ([2aee51f](https://github.com/damien-robotsix/robotsix-mill/commit/2aee51f17e905dde8c61cd4d8449e1e73eaec813))
* Add verification gate for implement agent's work-completion claims before accepting summary (20260812T031006Z-add-verification-gate-for-implement-agen-dd30) ([#2891](https://github.com/damien-robotsix/robotsix-mill/issues/2891)) ([c58697f](https://github.com/damien-robotsix/robotsix-mill/commit/c58697f835653afbb425a0e500ee179d8087062b))
* agent_limitation — The agent made 3 edit_file calls (ids: 65fd17ba7dc5e633, 28b6bb9e84a843b1, 29d3f782a7f58de (20260807T203600Z-agent-limitation-the-agent-made-3-edit-f-29d7) ([#2885](https://github.com/damien-robotsix/robotsix-mill/issues/2885)) ([c5ae727](https://github.com/damien-robotsix/robotsix-mill/commit/c5ae727c96f0f8ec4fe66df047f1e03a5e6e4cd5))
* agent_limitation — The implement agent's pre-flight scope gate mis-classified this PR as 'no Python files tou (20260804T123615Z-agent-limitation-the-implement-agent-s-p-469f) ([#2837](https://github.com/damien-robotsix/robotsix-mill/issues/2837)) ([a53532e](https://github.com/damien-robotsix/robotsix-mill/commit/a53532e7500a249f6ee229e2a516afc58322e24d))
* Answering an implement clarifying question should clear the stale-spec/fingerprint guard so the ticket doesn't re-block on resume (20260809T221733Z-answering-an-implement-clarifying-questi-718f) ([#2886](https://github.com/damien-robotsix/robotsix-mill/issues/2886)) ([14c860c](https://github.com/damien-robotsix/robotsix-mill/commit/14c860ce32a2b36edc64215c78d49ea1c48fb699))
* bespoke:security-posture-audit errors on hexarchy: ticket not found in any configured board (3×, trending up) (20260808T105912Z-bespoke-security-posture-audit-errors-on-4dc4) ([#2853](https://github.com/damien-robotsix/robotsix-mill/issues/2853)) ([c80bdba](https://github.com/damien-robotsix/robotsix-mill/commit/c80bdba0531989f0fbc2556b80a464e9e47bf85f))
* CI failure: CI on main (20260810T130051Z-ci-failure-ci-on-main-7383) ([#2845](https://github.com/damien-robotsix/robotsix-mill/issues/2845)) ([3c6670d](https://github.com/damien-robotsix/robotsix-mill/commit/3c6670d000f2e68cf52fc51baca21bb67a9d83ce))
* CI-failure fix creation should consider token-permission issues as a root cause category (20260809T060437Z-ci-failure-fix-creation-should-consider-ea88) ([#2862](https://github.com/damien-robotsix/robotsix-mill/issues/2862)) ([d12dbd8](https://github.com/damien-robotsix/robotsix-mill/commit/d12dbd884513c248edd8300444317a2937c90840))
* ci-fix: stop advertising "Resume to retry" on fingerprint-repeat blocks (20260808T182349Z-ci-fix-stop-advertising-resume-to-retry-a6b0) ([#2854](https://github.com/damien-robotsix/robotsix-mill/issues/2854)) ([89170b2](https://github.com/damien-robotsix/robotsix-mill/commit/89170b2a7b9adb438fdebf3ded3b5f3d1fab66f1))
* config drift: ci_fix_max_iterations default mismatch (model=3, config.example.json=5) (20260809T063902Z-config-drift-ci-fix-max-iterations-defau-e6ff) ([#2867](https://github.com/damien-robotsix/robotsix-mill/issues/2867)) ([37c95ab](https://github.com/damien-robotsix/robotsix-mill/commit/37c95ab6a8d56a9b64c0b9cb9cb7ce1628cb9c9a))
* config drift: ci_fix_wait_timeout_s default mismatch (model=900.0, json=1500.0) (20260810T022411Z-config-drift-ci-fix-wait-timeout-s-defau-484f) ([#2879](https://github.com/damien-robotsix/robotsix-mill/issues/2879)) ([b148875](https://github.com/damien-robotsix/robotsix-mill/commit/b14887519ff9696a0adf3fd0b13fb775db9d16cb))
* config drift: rebase_drop_exempt_paths missing `.secrets.baseline` entry (20260810T022411Z-config-drift-rebase-drop-exempt-paths-mi-40c6) ([#2880](https://github.com/damien-robotsix/robotsix-mill/issues/2880)) ([33e1ad5](https://github.com/damien-robotsix/robotsix-mill/commit/33e1ad564a0bd8fc8178c537feb3e4cce4fa0a34))
* config_sync pass ignores the _MODEL_FIELDS_NOT_IN_JSON allowlist and files false-positive drift drafts (20260809T125856Z-config-sync-pass-ignores-the-model-field-9d7f) ([#2873](https://github.com/damien-robotsix/robotsix-mill/issues/2873)) ([7a4e968](https://github.com/damien-robotsix/robotsix-mill/commit/7a4e968e3482dbf086d7204ebbdd5d3be6e4311a))
* Detect merge conflicts in the fix cycle and escalate instead of retrying (20260808T190210Z-detect-merge-conflicts-in-the-fix-cycle-4996) ([#2855](https://github.com/damien-robotsix/robotsix-mill/issues/2855)) ([d3f061e](https://github.com/damien-robotsix/robotsix-mill/commit/d3f061e82f9e20f1d58189d78227787174e1002c))
* Documentation stage calls ask_user (and attempts source edits) without pausing the ticket, leaving a merge-blocking [ASK_USER] thread (20260809T100924Z-documentation-stage-calls-ask-user-and-a-4cd9) ([#2869](https://github.com/damien-robotsix/robotsix-mill/issues/2869)) ([46a7b84](https://github.com/damien-robotsix/robotsix-mill/commit/46a7b84bd8bbbbbb8c4e76371bc1b97b16042391))
* Fix _changelog_validate.py: don't skip fragment validation when repo uses both release-please and towncrier (20260812T075808Z-fix-changelog-validate-py-don-t-skip-fra-9bbc) ([#2893](https://github.com/damien-robotsix/robotsix-mill/issues/2893)) ([4f4172b](https://github.com/damien-robotsix/robotsix-mill/commit/4f4172b688d88830665ebd42acda73184df45299))
* Fix triage NO_CHANGE path: verify branch is merged to main before closing as DONE (20260809T155749Z-fix-triage-no-change-path-verify-branch-bbcc) ([#2875](https://github.com/damien-robotsix/robotsix-mill/issues/2875)) ([8fc2ae4](https://github.com/damien-robotsix/robotsix-mill/commit/8fc2ae412b6ee7848845ebe79d0d1411cde8fbdf))
* Fix verification gate: extend _verify_summary_claims to handle 'added X to Y' phrasings and verify modifications via git diff (20260812T175136Z-fix-verification-gate-extend-verify-summ-1dac) ([#2895](https://github.com/damien-robotsix/robotsix-mill/issues/2895)) ([8dba9bf](https://github.com/damien-robotsix/robotsix-mill/commit/8dba9bf2abe2b85af5a9e8134193cfb3e45523ac))
* Implement agent adds stale paths to docs/modules.yaml without verifying file existence (2nd occurrence) (20260812T030204Z-implement-agent-adds-stale-paths-to-docs-f451) ([#2890](https://github.com/damien-robotsix/robotsix-mill/issues/2890)) ([c7d2e89](https://github.com/damien-robotsix/robotsix-mill/commit/c7d2e8961fddebdbef9ae0563175dc31ea90dbfa))
* Implement cycle retry limit should skip trivial cosmetic issues (20260807T221416Z-implement-cycle-retry-limit-should-skip-0a1c) ([#2846](https://github.com/damien-robotsix/robotsix-mill/issues/2846)) ([f5022c7](https://github.com/damien-robotsix/robotsix-mill/commit/f5022c721de8ce1dd7c0623a0c91828112ddf659))
* implement reports files it never wrote — no per-pass baseline, so a no-op sendback measures as 'passed' (20260809T115003Z-implement-reports-files-it-never-wrote-n-903b) ([#2871](https://github.com/damien-robotsix/robotsix-mill/issues/2871)) ([2a72f3a](https://github.com/damien-robotsix/robotsix-mill/commit/2a72f3ad4cc5c244fca326da0e23edb8c4fc5c80))
* optimization — The refine agent (sonnet, observation e3e5ef920f3d3319) produced 13,250 output tokens at $ (20260809T023020Z-optimization-the-refine-agent-sonnet-obs-7d4c) ([#2859](https://github.com/damien-robotsix/robotsix-mill/issues/2859)) ([4057142](https://github.com/damien-robotsix/robotsix-mill/commit/4057142d59bbd60e533154b53e91ad498eaecd96))
* pass_runner: same-board drafts bypass gap-id dedup — bespoke passes re-file identical tickets every run (20260809T061837Z-pass-runner-same-board-drafts-bypass-gap-0815) ([#2863](https://github.com/damien-robotsix/robotsix-mill/issues/2863)) ([0ea1bfe](https://github.com/damien-robotsix/robotsix-mill/commit/0ea1bfea4c363642bdf68779cc10eac5e8837821))
* stop blocking resume runs whose branch carries committed work ([#2896](https://github.com/damien-robotsix/robotsix-mill/issues/2896)) ([999609b](https://github.com/damien-robotsix/robotsix-mill/commit/999609bd57819d1eb52d8874be58dc8a254af023))
* stop blocking tickets on four recoverable conditions ([#2884](https://github.com/damien-robotsix/robotsix-mill/issues/2884)) ([1b34ada](https://github.com/damien-robotsix/robotsix-mill/commit/1b34adadacf024de1e633bb6e4e8fc93578db6e7))
* stop the four guards that made BLOCKED a one-way door ([#2866](https://github.com/damien-robotsix/robotsix-mill/issues/2866)) ([f8da7d5](https://github.com/damien-robotsix/robotsix-mill/commit/f8da7d5052da22e0d42a127d581e719280625507))
* survey parse error on robotsix-central-deploy: no JSON object in model response (2×) (20260807T013323Z-survey-parse-error-on-robotsix-central-d-e28c) ([#2842](https://github.com/damien-robotsix/robotsix-mill/issues/2842)) ([9207e5a](https://github.com/damien-robotsix/robotsix-mill/commit/9207e5ade9a7c23b95a1d0283934f9046fa784c4))
* trace-review files one draft per finding and misroutes across boards — one trace produced 4 drafts on 2 boards (20260809T062849Z-trace-review-files-one-draft-per-finding-87ba) ([#2865](https://github.com/damien-robotsix/robotsix-mill/issues/2865)) ([b03d7fe](https://github.com/damien-robotsix/robotsix-mill/commit/b03d7fe39a2d7e1ac8fa33d4d32119e54f621795))


### Documentation

* Fix stale module count in AGENT.md: says 19 modules, actual is 20 (20260812T075808Z-fix-stale-module-count-in-agent-md-says-eac5) ([#2892](https://github.com/damien-robotsix/robotsix-mill/issues/2892)) ([b2a2e80](https://github.com/damien-robotsix/robotsix-mill/commit/b2a2e80bb2c6bfde9eda6c3d2823ce20c83dceeb))
* Reorganize module deploy: align to per-module layout (src/docs/tests) (20260809T035024Z-reorganize-module-deploy-align-to-per-mo-e3e4) ([#2857](https://github.com/damien-robotsix/robotsix-mill/issues/2857)) ([c76c5b5](https://github.com/damien-robotsix/robotsix-mill/commit/c76c5b5a71f2eac8cf7877da3725e2754c4f5eca))
* Reorganize module skills: align to per-module layout (src/docs/tests) (20260809T035024Z-reorganize-module-skills-align-to-per-mo-78fd) ([#2858](https://github.com/damien-robotsix/robotsix-mill/issues/2858)) ([bb7c284](https://github.com/damien-robotsix/robotsix-mill/commit/bb7c284676dc7ba90b188a7caaad37c4f6429f81))
