...
- Move stage documentation from flat `docs/` to per-module `docs/stages/` directory (approval-gate, merge-stage, blocked-ticket-recovery, epic-dedup, retrospect-memory).
