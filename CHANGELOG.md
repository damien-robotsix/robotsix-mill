...
- Detect Docker daemon 503 errors in the sandbox layer and surface them as
  ``daemon_unavailable`` instead of a generic sandbox error.  Add a pre-flight
  health check in the implement agent so it short-circuits before burning
