...
- Audit test: update ``test_load_periodic_agent_definition_falls_back_to_builtin`` interval assertion from 86400 → 604800 (1d → 7d) to match the updated audit.yaml schedule.
