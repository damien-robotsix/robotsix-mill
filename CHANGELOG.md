...
- Implement `get_repo_description` on `GitLabForge` (reads project description via `GET /projects/:id`, clamping to GitLab's 2000-char limit with the same never-raise pattern as GitHub).
