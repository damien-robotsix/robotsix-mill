...
const SOURCE_CLASS={retrospect:"retrospect",audit:"audit","trace-health":"trace-health",health:"health",test_gap:"test-gap",agent:"agent","deep-review":"deep-review",survey:"survey",ci:"ci",env_sync:"env-sync",agent_check:"agent-check",bc_check:"bc-check",cost_reconciliation:"cost-reconciliation",completeness_check:"completeness-check","trace-review":"trace-review",roadmap_sync:"roadmap-sync"};const srcClass=s=>SOURCE_CLASS[s]||"user";
