...
_RUNNERS: dict[str, dict[str, str]] = {
    ...
    "member-sync": {
        "module": "agents.runners.member_sync_runner",
        "function": "run_member_sync_pass",
        "label": "Member-sync pass",
        "format": "member_sync",
    },
    "trace-health": {
        "module": "agents.runners.trace_health_runner",
        "function": "run_trace_health_check",
        "label": "Trace-health check",
        "format": "trace_health",
    },
    "trace-review": {
        "module": "agents.runners.trace_review_runner",
        "function": "run_trace_review_pass",
        "label": "Trace-review pass",
        "format": "trace_review",
    },
    "langfuse-cleanup": {
        "module": "agents.runners.langfuse_cleanup_runner",
    ...
    "run-health": {
        "module": "agents.runners.run_health_runner",
        "function": "run_run_health_pass",
        "label": "Run-health pass",
        "format": "memory_notes",
    },
    "diagnostic": {
        "module": "agents.runners.diagnostic_runner",
    ...
    "pin-bump": {
        "module": "agents.runners.pin_bump_runner",
        "function": "run_pin_bump_pass",
        "label": "Pin Bump pass",
        "format": "memory_drafts",
    },
    "roadmap-sync": {
        "module": "agents.runners.roadmap_sync_runner",
    ...
    "verify": {
        "module": "agents.runners.verify_runner",
    ...
    "data-dir-gc": {
        "module": "agents.runners.data_dir_gc",
