...
_YAML_PATH_TO_ALIAS: dict[str, str] = {
    ...
    "core.models.doc_classifier": "MILL_DOC_CLASSIFIER_MODEL",
    ...
    "periodic.config_sync.model": "MILL_CONFIG_SYNC_MODEL",
    "periodic.config_sync.enabled": "MILL_CONFIG_SYNC_PERIODIC",
    "periodic.config_sync.interval_seconds": "MILL_CONFIG_SYNC_INTERVAL_SECONDS",
    "periodic.config_sync.memory_path": "MILL_CONFIG_SYNC_MEMORY_PATH",
    ...
    "periodic.timeout_escalation.enabled": "MILL_TIMEOUT_ESCALATION_PERIODIC",
    "periodic.timeout_escalation.interval_seconds": "MILL_TIMEOUT_ESCALATION_INTERVAL_SECONDS",
    "periodic.timeout_escalation.threshold_seconds": "MILL_TIMEOUT_ESCALATION_THRESHOLD_SECONDS",
