...
_YAML_PATH_TO_ALIAS: dict[str, str] = {
    ...
    "core.limits.poll_backoff_enabled": "poll_backoff_enabled",
    "core.limits.poll_backoff_base_seconds": "poll_backoff_base_seconds",
    "core.limits.poll_backoff_max_seconds": "poll_backoff_max_seconds",
    "core.limits.poll_backoff_factor": "poll_backoff_factor",
