...
_SYSPROMPT_PATH = Path(__file__).parent.parent.parent.parent / "agent_definitions" / "completeness_check.yaml"
...
def run_completeness_check_agent(
    *,
    ...
    definition = load_agent_definition(
        Path(__file__).parent.parent.parent.parent / "agent_definitions" / "completeness_check.yaml"
    )
