...
from ._no_change import _run_no_change_contradiction_check
from ._shared import (
    _AgentRunOutcome,
    _ImplementContext,
...
class ImplementationLogicMixin(_ImplementationEditingMixin, _ImplementStageBase):
    ...
    def _detect_no_change_contradiction(
        ...
        return _run_no_change_contradiction_check(
            cls,
            ctx,
            ticket,
            repo_dir,
            ...
            target,
            extra_roots,
            short_circuit_verify=short_circuit_verify,
            git_ops=git_ops,
            target_branch_for=target_branch_for,
            attempt=attempt,
            max_iters=max_iters,
            new_ic=new_ic,
        )
