...
from robotsix_mill.runners.agent_check_runner import (
...
def test_run_agent_check_pass_empty_memory(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("robotsix_mill.runners.agent_check_runner.Settings", lambda: settings)
...
def test_agent_check_cli_command(capsys, tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "robotsix_mill.runners.agent_check_runner.run_agent_check_pass", mock_run
    )
