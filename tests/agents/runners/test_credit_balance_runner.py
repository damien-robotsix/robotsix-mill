"""Unit tests for robotsix_mill.agents.runners.credit_balance_runner."""

from unittest.mock import MagicMock, patch

from robotsix_mill.agents.runners.credit_balance_runner import (
...
class TestCheckCreditBalance:
    def test_no_key_configured_skips(self):
        with patch(
            "robotsix_mill.agents.runners.credit_balance_runner.get_secrets",
    ...
    def test_management_key_preferred(self):
        with (
            ...
            patch(
                "robotsix_mill.agents.runners.credit_balance_runner.httpx.get",
