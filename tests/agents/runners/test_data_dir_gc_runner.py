...
def test_prune_orphan_removes_old_orphan_dir(tmp_path):
    ...
    from robotsix_mill.agents.runners.data_dir_gc.orphans import (
...
def test_prune_orphan_knob_off_is_noop(tmp_path):
    ...
    import robotsix_mill.agents.runners.data_dir_gc as gc_mod
...
def test_prune_orphan_summary_line(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "robotsix_mill.agents.runners.data_dir_gc.Settings",
        lambda: s,
    )
