...
def _install_seams(monkeypatch, settings, forge, service):
    ...
    monkeypatch.setattr(
        "robotsix_mill.agents.runners.orphaned_pr_check.Settings",
        lambda: settings,
    )
    monkeypatch.setattr(
        "robotsix_mill.agents.runners.orphaned_pr_check.get_forge",
        lambda *a, **kw: forge,
    )
    monkeypatch.setattr(
        "robotsix_mill.agents.runners.orphaned_pr_check.TicketService",
        lambda *a, **kw: service,
    )
