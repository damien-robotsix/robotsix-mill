...
def test_agent_name_stamped_in_body(settings):
    ...
    tool = make_report_issue_tool(
        settings, board_id="test-board", agent_name="run_tests"
    )
...
def test_agent_name_none_falls_back_to_generic(settings):
    ...
    tool = make_report_issue_tool(settings, board_id="test-board", agent_name=None)
...
def test_agent_name_empty_string_falls_back(settings):
    ...
    tool = make_report_issue_tool(settings, board_id="test-board", agent_name="")
