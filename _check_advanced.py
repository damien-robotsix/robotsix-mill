...
non_advanced = ["branch_prefix", "api_host", "api_port", "api_url", "data_dir", "forge_kind", "forge_remote_url", "forge_target_branch", "github_api_url", "gitlab_api_url", "sandbox_image", "sandbox_proxy_url", "test_command", "smoke_command", "skills_dir", "language_instructions_dir"]
