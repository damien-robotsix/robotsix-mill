...
def build_schema() -> dict:
    ...
    from robotsix_mill.config.settings import LangfuseConfig, OpenrouterKeys, Settings
    ...
    openrouter_schema = OpenrouterKeys.model_json_schema()
    _hoist_defs(openrouter_schema, root_defs)
